...
fn writeGrammar(grammar: Grammar) !void {
    ...
    var errors_name = try String.initWithValue(grammar.grammar_name);
    defer errors_name.deinit();
    try errors_name.append(".errors.zig");
    ...
    // Actions
    {
        ...
        try out.stream.print("const Errors = @import(\"{}\");\n", errors_name.view());
